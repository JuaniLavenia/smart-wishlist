  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-card p-6 rounded-xl border border-border/60 shadow-sm">
        <h2 className="text-lg font-semibold mb-2 text-foreground">API SerpApi</h2>
        <p className="text-sm text-muted-foreground mb-6">
          El contador local es un estimado. Para accuracy, ingresá el valor real desde el{' '}
          <a
        ...
        <div className="flex items-center gap-4 p-4 bg-muted rounded-lg mb-4">
          <div>
            ...
            <div className="text-xs text-muted-foreground">búsquedas usadas</div>
          </div>
          <div className="text-xl font-medium text-muted-foreground">/ 250</div>
          <div className="ml-auto text-right">
            <div className={`text-lg font-semibold ${percentage >= 80 ? 'text-amber-600' : 'text-green-600'}`}>
              {percentage}%
            </div>
            <div className="text-xs text-muted-foreground">{remaining} restantes</div>
          </div>
        </div>
      ...
      <div className="bg-card p-6 rounded-xl border border-border/60 shadow-sm">
        <h2 className="text-lg font-semibold mb-4 text-foreground">Tiendas habilitadas</h2>
        <p className="text-sm text-muted-foreground mb-6">
          Las tiendas deshabilitadas no aparecerán en los resultados de búsqueda.
        </p>
